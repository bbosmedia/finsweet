...
export const Requirements: string[] = [
	'Native Android Development (Java Kotlin) 4+ years commercial',
	'Understanding of Android Phone modification',
	'Native Android full stack development',
	'Building and customising stock and derived images based on Android Open - Source Project',
	'Integration of hardware platforms (writing device drivers)',
	'Performance optimisation'
]
export const Responsibilities: string[] = [
	'Contract Devs are UK based out-staffing specialists that source talented developers to work remotely for our clients on long term contracts.',
	'We represent a number of fast growing London based start-ups that are looking for permanent employees to work remotely. As a 100% remote team we are split between London, Bristol, Lviv, and Portsmouth.'
]
