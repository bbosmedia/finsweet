...
const HomeProcess = () => {
	return (
		<section className='py-24 max-[425px]:py-[30px] home-process'>
			<div className='max-w-[1320px] w-full px-5 mx-auto'>
				<span className='font-medium [letter-spacing:3px] uppercase opacity-[0.87] mb-4 text-black'>Our Process</span>
				...
				<div className='grid gap-12 grid-cols-3 lg:grid-cols-2 md:grid-cols-1 md:gap-6 md:mt-5 mt-[68px]'>
