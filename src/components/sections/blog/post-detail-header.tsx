...
const PostDetailHeader = () => {
	return (
		<header className='py-24 max-[425px]:py-[30px] max-md:py-16 max-xlsm:py-10'>
			...
			<img
				className='absolute top-0 right-0 rotate-90 max-md:hidden'
				src='/images/btn-shape.webp'
				srcSet='/images/btn-shape@2x.webp 2x'
				alt=''
			/>
				<h2 className='font-semibold text-[48px] leading-[1.2] text-darkBlue max-md:text-[36px] max-lsm:text-[28px] max-[425px]:text-[32px] max-[320px]:text-[27px] mb-6 max-md:mb-4 max-w-[729px]'>
					Breaking the code How did we build our Figma plugin
				</h2>
				<p className='block mb-8 max-md:mb-3 max-w-[719px]'>
				...
				<div className='flex items-center gap-3'>
					...
					<div className='flex items-center gap-3 max-md:flex-col max-md:items-start max-md:gap-0'>
						<p className='pr-3 border-r border-r-black/20 max-md:border-r-0'>
							Andrew Jonson
						</p>
