			...
			<div className='max-w-[1320px] w-full px-5 mx-auto'>
				<div className='flex justify-between gap-5 max-md:flex-col'>
					<div className='w-1/2 max-md:w-full'>
						...
						<Link to='/blog/1'>
							<h2 className='font-semibold text-[48px] leading-[1.2] text-darkBlue max-md:text-[36px] max-lsm:text-[28px] max-[425px]:text-[32px] max-[320px]:text-[27px] mb-6 max-lsm:mb-4'>
								Breaking the code How did we build our Figma plugin
							</h2>
						</Link>
						<p className='block mb-6 max-lsm:mb-4'>
							It is a long established fact that a reader will be distracted by
							the readable content of a page when looking at its layout. The
							Maker is a decentralized. We aim to attain the.
						</p>
						<Link className='flex items-center gap-3 mb-10 max-lsm:mb-5' to='/'>
							<span className='text-main'>Read More</span> <BsArrowRight />
						</Link>
						<div className='flex items-center gap-3 mb-14 max-lsm:flex-col max-lsm:items-start'>
							<div className='flex items-center gap-3 pr-3 border-r border-r-black/20 max-lsm:border-r-0'>
								<Link to='/blogger/1'>
					...
					<div className='w-1/2 max-md:w-full max-w-[515px]'>
						<div className='w-full bg-siteOrange flex flex-col gap-16 relative max-lsm:gap-6 p-[72px] max-lsm:p-5 max-md:p-8'>
							<img
								className='absolute top-0 right-0 rotate-90 max-lsm:hidden'
							...
							<div>
								<Link to='/blog/1'>
									<h3 className='font-semibold text-siteDark mb-4 text-[24px] leading-[36px] max-lsm:text-[20px] max-lsm:leading-[1.4]'>
