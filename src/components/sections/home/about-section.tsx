	...
	return (
		<section className='py-24 max-[425px]:py-[30px] pt-[120px]'>
			...
			<div className='grid grid-cols-3 gap-3 pr-4 mt-12 relative md:grid-cols-1 md:pr-0 md:mt-5'>
				<img className='w-full object-cover h-[400px]' src="/images/home-about/1.jpg" alt='' />
				<img className='w-full object-cover h-[400px]' src="/images/home-about/2.jpg" alt='' />
				<img className='w-full object-cover h-[400px]' src="/images/home-about/3.jpg" alt='' />
