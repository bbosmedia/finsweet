...
const ExpertiseSection = () => {
	return (
		<section className='py-24 max-[425px]:py-[30px] bg-lightBlue max-md:py-16 max-xlsm:py-10'>
			<Container className='flex gap-[20px] justify-between max-md:flex-col max-md:gap-[30px]'>
				<div className='w-1/2 max-w-[624px] max-md:w-full'>
					<p className='font-medium [letter-spacing:3px] uppercase opacity-[0.87] mb-4 text-black'>
						Our expertise
					</p>
					<h3 className='font-semibold text-[48px] leading-[1.2] text-darkBlue max-md:text-[36px] max-lsm:text-[28px] max-[425px]:text-[32px] max-[320px]:text-[27px] mb-6'>
				...
				<div className='flex flex-col gap-3 relative w-1/2 max-w-[515px] max-md:w-full'>
					...
					<div className='absolute -top-4 left-0 w-4 h-4 bg-main max-xlsm:hidden' />
					{expertiseItems.map(item => (
						<div
							key={item.title}
							className='bg-white flex p-8 gap-4 w-full max-xlsm:flex-col max-xlsm:items-center max-xlsm:text-center'
						>
