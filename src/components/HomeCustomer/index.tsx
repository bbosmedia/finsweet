			...
			<div className="container">
				<div className="home-customer-inner">
					<div className="content">
						...
						<span className="bolder">Transform your idea into reality with finsweet</span>
						...
						<div className="images">
							<img src={require('../../assets/images/home-customers/1.png')} alt="Customer" />
							<img src={require('../../assets/images/home-customers/2.png')} alt="Customer" />
							<img src={require('../../assets/images/home-customers/3.png')} alt="Customer" />
						</div>
