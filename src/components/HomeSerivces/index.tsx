	...
	return (
		<section className="section home-services bg-siteOrange">
			<div className="container">
				...
				<h3 className="section-title">We build software solutions that solve client's business challenges</h3>
				<MainButton text="Start Project" link="/" />
				<div className="cards">
					<div className="card">
						<img src={require('../../assets/images/home-services/1.png')} alt="" />
					...
					<div className="card">
						<img src={require('../../assets/images/home-services/2.png')} alt="" />
					...
					<div className="card">
						<img src={require('../../assets/images/home-services/3.png')} alt="" />
						<h5>Development</h5>
						<p>We aim to attain the greatest satisfaction for our clients and be one of the prominent names when it comes to world-class service</p>
						<Link to="/">
							Read More <BsArrowRight />
