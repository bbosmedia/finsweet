			...
			<div className='flex justify-between lsm:flex-col lsm:gap-3 lsm:items-start'>
				<div className='flex items-center'>
					...
					<aside>
						...
						<p className='font-medium text-gray-500 text-[14px] leading-[20px]'>Director, Company</p>
					</aside>
				</div>
				<img className='h-[25px] w-auto object-contain' src="/images/logos/1.png" alt='Logo' />
			</div>
		</div>
	)
}
