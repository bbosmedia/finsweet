...
const serviceLinks = ['Technical Support', 'Development', 'AWS/Azure', 'Consulting', 'Information Technology']
const resourceLinks = ['FAQ', 'Blog', 'Help Center', 'Terms of Service', 'Privacy Policy']
